/** biome-ignore-all lint/correctness/noUnusedVariables: external */
/** biome-ignore-all lint/style/useLiteralEnumMembers: external */
/** biome-ignore-all lint/suspicious/noExplicitAny: external */
...
/** @public */
export interface GangMemberExpGain {
